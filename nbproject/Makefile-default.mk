...
FINAL_IMAGE=${DISTDIR}/Blink_LED_GP2_ASM_10F200.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=BlinkGP2main.as

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/BlinkGP2main.o
POSSIBLE_DEPFILES=${OBJECTDIR}/BlinkGP2main.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/BlinkGP2main.o

# Source Files
SOURCEFILES=BlinkGP2main.as
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/Blink_LED_GP2_ASM_10F200.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC10F200
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/Blink_LED_GP2_ASM_10F200.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/BlinkGP2main.o: BlinkGP2main.as  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/BlinkGP2main.o 
	${MP_AS} -mcpu=PIC10F200 -c \
	-o ${OBJECTDIR}/BlinkGP2main.o \
	BlinkGP2main.as \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/Blink_LED_GP2_ASM_10F200.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC10F200 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/Blink_LED_GP2_ASM_10F200.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
